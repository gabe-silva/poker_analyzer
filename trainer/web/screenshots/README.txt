Screenshot Drop Folder For Landing Page
...
The landing page auto-loads these from /screenshots/<filename>. If a file is missing, a placeholder is shown.

After you add the files:
1) commit/push locally
2) git pull on PythonAnywhere
3) click Reload for the web app
